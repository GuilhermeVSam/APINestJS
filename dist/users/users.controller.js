...
let UsersController = class UsersController {
    ...
    create(createUserDto) {
        try {
            ...
            throw new common_1.HttpException(exception.message, exception.status);
        }
    }
    findAll() {
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 400, description: 'ID duplicado' }),
    (0, swagger_1.ApiResponse)({ status: 409, description: 'Email duplicado' }),
    (0, common_1.Post)(),
